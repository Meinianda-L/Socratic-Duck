...
const TAG_FULL = 'Socratic Duck — the rubber duck that asks, not answers'
const TAG_MID = 'Socratic Duck — ask, don\'t tell'
const TAG_TINY = 'Socratic Duck'
const HIDE_BELOW = 34
      ...
      <Box flexDirection="column" width={w}>
        ...
        {typeof info.update_behind === 'number' && info.update_behind > 0 && (
          <Text bold color={t.color.warn}>
            ...
            <Text bold color={t.color.warn}>
              {info.update_command || './run.sh setup'}
            </Text>
            <Text bold={false} color={t.color.warn} dimColor>
              {' '}
              to update
