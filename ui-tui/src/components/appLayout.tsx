            ...
            <Box flexDirection="column" key={row.key} ref={transcript.virtualHistory.measureRef(row.key)}>
              ...
              {row.msg.kind === 'intro' ? (
                <Box flexDirection="column" paddingTop={1}>
                  ...
                  <Text color={ui.theme.color.muted}>{ui.theme.brand.name} v{ui.info?.version || '0.3.0'}{ui.info?.release_date ? ` (${ui.info.release_date})` : ''}</Text>
                  <Box height={1} />
                  <Text color={ui.theme.color.text}>🐤  Paste file paths → I will read them.  Code blocks → sandbox.</Text>
                </Box>
